...
export declare function captureTrackedDiff(pi: ExtensionAPI, root: string, snapshot: WorkingTreeSnapshot, budget?: TrackedDiffBudget, signal?: AbortSignal): Promise<TrackedDiffCapture>;
