...
export declare function selectTrackedGroups(groups: readonly TrackedGroup[], snapshot: WorkingTreeSnapshot, headSizes: ReadonlyMap<string, number>, states: ReadonlyMap<string, GitFileState>, indexSizes: IndexPathSizes | undefined, budget: TrackedDiffBudget, omissions: Map<number, DiffFile>, signal?: AbortSignal): SelectedGroup[];
