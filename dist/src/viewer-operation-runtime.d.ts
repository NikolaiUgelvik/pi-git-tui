...
import type { MutationOutcome, OperationExecutionContext, OperationSnapshot, OperationToken, RefreshIntent } from "./viewer-operation-types.js";
...
export interface OperationExecutionRuntime {
    ...
    storeRefreshFailure: <T>(active: ActiveOperation, intent: RefreshIntent<T>, failure: FailureDetails, completion: OperationSnapshot, failedSummary: string, successMessage?: string) => void;
