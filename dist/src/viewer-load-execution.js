...
export async function executeLoad(runtime, active, spec) {
    try {
        ...
        runtime.finish(active, successMessage
        ...
        runtime.finish(active, spec.reportFailure === false
            ? { state: "idle", canRetryRefresh: false }
...
//# sourceMappingURL=viewer-load-execution.js.map