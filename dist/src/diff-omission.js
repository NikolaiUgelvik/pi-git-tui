...
function byteBudgetMessage(details, fallback) {
...
function omissionMessage(reason, details) {
    if (details.detail) {
...
export function createDiffOmission(reason, details = {}) {
    return {
        reason,
...
export function omittedDiffFile(options) {
    return {
        path: options.path,
...
//# sourceMappingURL=diff-omission.js.map