...
export function helpActionsForDocument(context, document) {
    if (context !== "viewer") {
        return HELP_ACTIONS[context];
    }
    return HELP_ACTIONS.viewer.filter((action) => action.viewerAction === undefined || isViewerActionAvailable(document, action.viewerAction));
}
//# sourceMappingURL=viewer-help.js.map