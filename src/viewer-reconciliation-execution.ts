...
import { combinedRefreshFailure, type PendingRefresh, refreshFailureSnapshot } from "./viewer-refresh-recovery.js"

export async function reconcileCancellation<T, R>(
  runtime: OperationExecutionRuntime,
  active: ActiveOperation,
  intent: RefreshIntent<R>,
  mutation?: T,
...
export async function reconcileMutationFailure<T, R>(
  runtime: OperationExecutionRuntime,
  active: ActiveOperation,
  intent: RefreshIntent<R>,
  mutationFailure: ReturnType<typeof failureDetails>,
): Promise<MutationOutcome<T>> {
  active.phase = "reconcile"
  active.controller = new AbortController()
  runtime.setSnapshot({
...
export async function executeRefreshRetry(
  runtime: OperationExecutionRuntime,
  active: ActiveOperation,
