const SIMPLE_ESCAPES: Readonly<Record<string, number>> = Object.freeze({
  a: 0x07,
  b: 0x08,
  t: 0x09,
  n: 0x0a,
...
function decodeOctal(value: string, offset: number): { byte: number; nextOffset: number } | undefined {
